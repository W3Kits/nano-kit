...
function ActionCard({ icon, title, desc, onClick, color }: {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="w-full px-3 py-2.5 rounded-xl cursor-pointer flex items-center gap-3 transition-colors border border-transparent hover:bg-[var(--bg-tertiary)] text-left"
    >
